...
const IntegranteIzquierda = ({ titulo, texto, imagen, icon, instagram }) => {
  useEffect(() => {
    AOS.init();
  }, [])
  ...
  return (
    <article className='container-fluid'>
      <div className='row bg-almagrey'>
        <div className='col-lg-5 p-0 d-flex justify-content-center'>
          <img src={imagen} alt="" className={`w-100 ${styles.imagenIntegrante}`} />
        </div>
        <div className='col col-lg d-flex flex-column justify-content-center align-items-center text-light p-sm-5 py-5' data-aos="zoom-in">
...
export default IntegranteIzquierda
